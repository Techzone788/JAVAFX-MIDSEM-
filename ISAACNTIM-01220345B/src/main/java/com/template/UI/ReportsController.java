...
public class ReportsController {
    ...
    @FXML
    private TableView<StudentClass> reportTable;
    ...
    private final ObservableList<StudentClass> reportList =
    ...
    private void handleLoadReport() {
        ...
        reportList.addAll(studentValidation.getAtRiskStudents(threshold));
        DataLogg.log("At-risk report generated with GPA threshold:" + threshold);
    }
    ...
    private void handleExportCSV() {
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            // Write table data
            for (StudentClass s : reportTable.getItems()) {
                writer.write(
                        s.getStudentId() + "," +
                                s.getFullName() + "," +
                                s.getProgramme() + "," +
    ...
    private void handleImportCSV() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                boolean added = studentValidation.addStudent(studentClass);
               if(added){
                importedCount++;
            }else{
                   skippedCount++;
            ...
            DataLogg.log(importedCount + "Students imported from CSV");
            DataLogg.log(skippedCount + "duplicate students skipped during CSV import");
            alert.showAndWait();
